...
function CardComponent({product}) {
  ...
  return (
    <div className="w-[300px] border border-grayColor rounded-[20px] flex flex-col items-center justify-center">
      ...
      <Link to={`/singleProduct/${product.id}`} className="bg-mainBlue text-textWhite px-[16px] py-[8px] rounded-lg my-[20px] hover:bg-mainYellow transition-all duration-300">View More</Link>
    </div>
  )
}
